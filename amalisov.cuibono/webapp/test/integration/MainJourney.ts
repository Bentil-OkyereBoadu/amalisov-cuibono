...
opaTest(
	"Should navigate to Participants page when button is pressed",
	function (Then: any) {
		//Arrangements
...
opaTest(
	"Should navigate to Calculated Bonus page when button is pressed",
	function (Then: any) {
		//Arrangements
		onTheAppPage.iStartMyApp();
...
opaTest(
	"Should navigate to the edit page when the edit or duplicate button are pressed",
	function (Given: any, When: any, Then: any) {
		// Arrangements
...
opaTest(
	"Should enter text into search field and filter table data",
	function (Given: any, When: any, Then: any) {
		// Arrangements
		onTheMainPage.iStartMyApp();
...
QUnit.module(
	"Participants Checkbox Journey and open a dialog with exclude button"
);

opaTest(
	"Should Check all checkboxes on Participants page when button is pressed and click exclude button to open a dialog",
	function (Then: any) {
		//Arrangements
...
QUnit.module(
	"Participants Checkbox Journey and open a dialog with overRule button"
);

opaTest(
	"Should Check all checkboxes on Participants page when button is pressed and click overRule button to open a dialog",
	function (Then: any) {
		//Arrangements
		onTheParticipantsPage.iStartMyApp();
...
opaTest(
	"Should navigate to the Create page when the create tranche button is pressed",
	function () {
		// Arrangements
		onTheMainPage.iStartMyApp();
...
opaTest(
	"Should open the Add Target Dialog when the Add Target button is pressed",
	function () {
		// Actions
...
opaTest("Should enter text into the target name input the", function () {
	// Actions
	onTheEditPage.iEnterTextIntoTargetNameField("Integration target 1");
...
opaTest(
	"should press the edit button and see the edit target dialog",
	function (Then: any) {
		// Actions
		onTheEditPage.iPressOnTheEditTargetButton();
		// Assertion
		onTheEditPage.iShouldSeeTheTargetDialogOpen();
		onTheEditPage.iShouldSeeTargetDataFilled();

		// Actions
		onTheEditPage.iEnterTextIntoTargetNameField("Edited name");
		//Assertion
		onTheEditPage.iShouldSeeTheEditedTargetNameInInput();
